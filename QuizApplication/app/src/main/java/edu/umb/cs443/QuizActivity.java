...
public class QuizActivity extends AppCompatActivity {
    ...
    private TextView textViewQuizNr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewQuizNr = findViewById(R.id.text_view_quizNr);
        ...
        quizId = intent.getStringExtra(StudentActivity.QUIZ_NR);
    ...
    private void showNextQuestion() {
        ...
        rbGroup.clearCheck();
        textViewQuizNr.setText(quizId);

        if (questionCounter < questionCountTotal && questionCountTotal != 0) {
    ...
    private void finishQuiz() {
        ...
        resultIntent.putExtra(QUESTION_COUNT,questionCountTotal);
